...
def listener():
  ...
  traveling_distance_topic = rospy.get_param("~traveling_distance_topic")
  time_duration_topic = rospy.get_param("~time_duration_topic")
  explored_volume_topic = rospy.get_param("~explored_volume_topic")
  rospy.Subscriber(time_duration_topic, Float32, timeDurationCallback)
  rospy.Subscriber("/runtime", Float32, runTimeCallback)
  rospy.Subscriber(explored_volume_topic, Float32, exploredVolumeCallback)
  rospy.Subscriber(traveling_distance_topic, Float32, travelingDistanceCallback)
